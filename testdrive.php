				...
				<div class="row">
					<div class="col-12">
						<div class="signin-form">
							<h2>Туршилтаар шалгах</h2>
							<div class="row" style="margin-left: 5px">
								<div class="form-group" style="width: 95%">
									<i class="icofont-phone"></i>
									<input type="text" name="testdrive_phone" placeholder="Хүлээн авагчийн утасны дугаар" required="required">
								</div>
								...
								<div class="form-group button">	
									<button type="submit" class="btn primary"><i class="fa fa-send"></i>Илгээх</button>
								</div>
							</div>
						</div>
					</div>
